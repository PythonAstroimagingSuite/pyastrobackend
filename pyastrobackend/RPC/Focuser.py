...
class Focuser(RPCDevice, BaseFocuser):
    ...
    def get_absolute_position(self):
        ...
        logging.info(f'RPC:get_absolute_position image')
        ...
        logging.info(f'RPC get_absolute_position status/resp = {status} {resp}')
    ...
    def get_max_absolute_position(self):
        logging.info(f'RPC:get_max_absolute_position image')
    ...
    def get_current_temperature(self):
        logging.info(f'RPC:get_current_temperature image')
    ...
    def is_moving(self):
        logging.info(f'RPC:is_moving image')
        ...
        logging.info(f'RPC is_moving status/resp = {status} {resp}')
    ...
    def stop(self):
        logging.info(f'RPC:focuser_stop')
        ...
        logging.info(f'RPC focuser_stop status/resp = {status} {resp}')
    ...
    def move_absolute_position(self, abspos):
        logging.info(f'RPC:move_absolute_position to {abspos} ')
        ...
        logging.info(f'RPC move_absolute_position status/resp = {status} {resp}')
